...
public sealed class FirmaOperaCloudDbContext : DbContext
{
    ...
    public DbSet<RegistrationCardDraft> RegistrationCardDrafts => Set<RegistrationCardDraft>();
    ...
    {
        modelBuilder.Entity<RegistrationCardDraft>(entity =>
        {
            entity.ToTable("RegistrationCardDrafts");
            entity.HasKey(x => new { x.HotelId, x.ConfirmationNumber, x.ReservationId });
            entity.Property(x => x.HotelId).HasMaxLength(20);
            entity.Property(x => x.ConfirmationNumber).HasMaxLength(64);
            entity.Property(x => x.ReservationId).HasMaxLength(64);
            entity.Property(x => x.Revision).IsConcurrencyToken();
            entity.Property(x => x.InputJson).HasColumnType("nvarchar(max)").IsRequired();

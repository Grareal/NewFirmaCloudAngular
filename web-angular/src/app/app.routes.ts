...
export const routes: Routes = [
  ...
  { path: 'busqueda', redirectTo: 'operacion', pathMatch: 'full' },
  ...
  { path: 'tarjeta/:confirmation', loadComponent: () => import('./features/tarjeta/tarjeta').then(m => m.TarjetaComponent), canActivate: [authGuard], data: { layout: 'guest', permission: P.RegistrationCard } },
  ...
  { path: 'consulta-firmas', loadComponent: () => import('./features/firmas/firmas').then(m => m.FirmasComponent), canActivate: [authGuard], data: { layout: 'guest', permission: P.SignatureLookup } },
  { path: 'meseros', loadComponent: () => import('./features/firmas/firmas').then(m => m.FirmasComponent), canActivate: [authGuard], data: { layout: 'guest', permission: P.SignatureLookup } },
  ...
  { path: 'huesped', loadComponent: () => import('./features/huesped/huesped').then(m => m.HuespedComponent), canActivate: [authGuard], data: { layout: 'guest' } },
  { path: 'huesped/:confirmation', loadComponent: () => import('./features/huesped/huesped').then(m => m.HuespedComponent), canActivate: [authGuard], data: { layout: 'guest' } },
  { path: 'bienvenida', loadComponent: () => import('./features/huesped/huesped').then(m => m.HuespedComponent), canActivate: [authGuard], data: { layout: 'guest' } },
